...
export const UI_STRINGS = {
  en: {
    ...
    switchLanguageAria: 'Auf Deutsch ansehen',
    noGermanVersion: 'No German version of this page',
  ...
  de: {
    ...
    switchLanguageAria: 'View in English',
    noGermanVersion: 'Keine deutsche Version dieser Seite',
